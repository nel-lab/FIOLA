...
with h5py.File(path,'r') as h5:
    mov = np.array(h5['mov'])
with h5py.File(os.path.join(base_folder, filename),'r') as h5:
...
plt.plot(traces[0]);plt.plot(gt[0])
#%%
