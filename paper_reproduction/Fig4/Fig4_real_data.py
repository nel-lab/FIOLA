...
#%% 9a and 9b
#result = np.load('/media/nel/storage/NEL-LAB Dropbox/NEL/Papers/VolPy_online/result/test_speed_spike_extraction/from_johannes.npz')
# t100 = result['t100']
# t500 = result['t500']
# timing = result['timing']

result = np.load('/media/nel/storage/NEL-LAB Dropbox/NEL/Papers/VolPy_online/result/test_speed_spike_extraction/calcium_new.npy', allow_pickle=True)
timing, t500, t100 = result
...
plt.gca().spines['right'].set_visible(False)
plt.tight_layout(pad=.1)
plt.savefig('/media/nel/storage/NEL-LAB Dropbox/NEL/Papers/VolPy_online/figures/v3.0/supp/Fig_timing_deconv_quartiles_v4.1.pdf')
...
ax.set_ylabel('Time (ms)')    
plt.savefig('/media/nel/storage/NEL-LAB Dropbox/NEL/Papers/VolPy_online/figures/v3.0/supp/Fig_supp_detection_timing_calcium_boxplot_v4.0.pdf')
