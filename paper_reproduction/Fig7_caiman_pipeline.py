...
#        fnames = [download_demo(fnames[1])]
    ...
    fnames = ['/media/nel/DATA/fiola/R2_20190219/mov_R2_20190219T210000_3000.hdf5']
...
# %% RE-RUN seeded CNMF on accepted patches to refine and perform deconvolution
    ...
    if display_images:
        cnm2.estimates.play_movie(images, q_max=99.9, gain_res=1,frame_range=slice(0, 1000, 1),
                                  magnification=0.5,
                                  bpx=border_to_0, 
