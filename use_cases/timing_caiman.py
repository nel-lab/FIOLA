...
#%%
    folder = '/home/nel/NEL-LAB Dropbox/NEL/Papers/VolPy_online/CalciumData/DATA_PAPER_ELIFE/N.00.00/images_N.00.00'
    fnames = sorted(os.listdir(folder))[:1000]
    fnames = [os.path.join(folder, name)for name in fnames]
    m = cm.load(fnames)
    m.save('/home/nel/NEL-LAB Dropbox/NEL/Papers/VolPy_online/CalciumData/DATA_PAPER_ELIFE/N.00.00/changjia_test_time/N.00.00_1000.hdf5')
    
    #%%
    fnames = ['/home/nel/NEL-LAB Dropbox/NEL/Papers/VolPy_online/CalciumData/DATA_PAPER_ELIFE/N.00.00/changjia_test_time/N.00.00_1000.hdf5']
    fld_name = '/home/nel/NEL-LAB Dropbox/NEL/Papers/VolPy_online/CalciumData/DATA_PAPER_ELIFE/N.00.00/changjia_test_time'
